...
{
    Import-LocalizedData -BindingVariable LocalizedData -filename VMCertificate.psd1 `
...
<#
.SYNOPSIS
Gets the current state of the VMCertificate resource. Works only on Windows Server 2016.

.DESCRIPTION
Gets the current state of the VMCertificate resource. 
